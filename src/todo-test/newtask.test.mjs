...
import newTaskEl, {template as newTaskTmpl} from "../templates/new-task.js"
...
describe("New Task", () => {
  ...
  it("should disabled create task button when app starts", function(){
    ...
    const newTaskCreate = newTaskEl.querySelector(".new-task-create");
  ...
  it("should enable create task button when input have a text", function(){
    ...
    const newTaskTitle = newTaskEl.querySelector(".new-task-title");
    const newTaskCreate = newTaskEl.querySelector(".new-task-create");
 ...
 it("should check if the input is empty once the button is clicked", function(){
    const newTaskInput = newTaskEl.querySelector(".new-task-title");
    const newTaskCreate = newTaskEl.querySelector(".new-task-create");
    // 1) Ingresar al input
    // 2) ingresar texto
    // 3) clickear el botón
